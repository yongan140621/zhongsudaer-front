    ...
    desc: (
      <>
        <div>
          ...
          <div className="mb-4">1、产品设计采购SDRC公司先进的计算机软件I-Deas，对阀门结构造型进行三维设计和有限元分析，使产品结构更趋合理、性能优良。</div>
          <div className="mb-4">2、产品制造采用高精度的数控机床和加工中心进行机械加工，产品的质量得到保证。能与进口装置、设备配用。</div>
          <div className="mb-4">3、球阀系列产品严格按照API、ASME标准进行设计、制造、检验和试验，阀门达到微泄露要求。</div>
    ...
    desc: (
      <>
        <div>
          ...
          <div className="mb-4">1、产品设计采购SDRC公司先进的计算机软件I-Deas，对阀门结构造型进行三维设计和有限元分析，使产品结构更趋合理、性能优良。</div>
          <div className="mb-4">2、产品制造采用高精度的数控机床和加工中心进行机械加工，产品的质量得到保证。能与进口装置、设备配用。</div>
          <div className="mb-4">3、止回阀系列产品严格按照API、ASME标准进行设计、制造、检验和试验，高位高压阀门进行热态试验、阀门达到微泄露要求。</div>
    ...
    desc: (
      <>
        <div>
          ...
          <div className="mb-4">1、产品设计采购SDRC公司先进的计算机软件I-Deas，对阀门结构造型进行三维设计和有限元分析，使产品结构更趋合理、性能优良。</div>
          <div className="mb-4">2、产品制造采用高精度的数控机床和加工中心进行机械加工，产品的质量得到保证。能与进口装置、设备配用。</div>
          <div className="mb-4">3、截止阀系列产品严格按照API、ASME标准进行设计、制造、检验和试验，高位高压阀门进行热态试验、阀门达到微泄露要求。</div>
    ...
    desc: (
      <>
        <div>
          ...
          <div className="mb-4">1、产品设计采购SDRC公司先进的计算机软件I-Deas，对阀门结构造型进行三维设计和有限元分析，使产品结构更趋合理、性能优良。</div>
          <div className="mb-4">2、产品制造采用高精度的数控机床和加工中心进行机械加工，产品的质量得到保证。能与进口装置、设备配用。</div>
          <div className="mb-4">3、 闸阀系列产品严格按照API、ASME标准进行设计、制造、检验和试验，高位高压阀门进行热态试验、阀门达到微泄露要求。</div>
